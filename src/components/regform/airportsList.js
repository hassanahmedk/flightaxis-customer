...
// create a new array without the unwanted properties
const newAirports = airports.map(
  ({ name, city, country, iata_code }) =>
    city + ", " + name + " Arpt [" + iata_code + "], " + country
);

// save the new array to a file using Node.js's file system module

fs.writeFileSync("newAirports.json", JSON.stringify(newAirports));
