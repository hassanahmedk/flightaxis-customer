	...
	return (
		...
		>
          ...
          {state.formData.going_to.split(",")[0]}
			...
			<Paper
				elevation={2}
				sx={{ p: "30px", borderRadius: "10px", width: "80vw" }}
			>
				<Stack
					direction="column"
					justifyContent="center"
				...
				>
					...
					<Stack direction="column" justifyContent="center" alignItems="center">
						<img src="/images/exclusive-offer.png" alt="offer" width="180vw" />
						<Typography
							variant="subtitle1"
							textAlign="center"
					...
					>
						...
						>
							<Typography variant="h6" sx={{ fontFamily: "Bahnschrift" }}>
								Book now
							</Typography>
						</Button>
						<Box
						...
						>
							<Typography sx={{ fontFamily: "Bahnschrift" }}>OR</Typography>
						</Box>
						<Button
							variant="contained"
							sx={{
